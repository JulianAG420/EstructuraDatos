...
/**
    ...
    /**
     * 4.Escriba un programa que sume N números recursivamente y muestre la
     * sumatoria.
     *
     ...
     */
    public static int sumarNumerosAnteriores(int numero) {
        int suma;
        if (numero > 0) {
            suma = numero + sumarNumerosAnteriores(numero - 1);
        } else {
            return 0;
        }
        return suma;
